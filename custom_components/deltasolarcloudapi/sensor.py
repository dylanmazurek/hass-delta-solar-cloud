...
from .deltasolarcloud import DeltaSolarCloud
...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    api = DeltaSolarCloud(config.get(CONF_USERNAME), config.get(CONF_PASSWORD))
...
class DeltaInverterSensor(SensorEntity):
    """Representation of a Delta Inverter Sensor."""
